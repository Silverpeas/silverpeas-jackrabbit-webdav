...
public abstract class AbstractLocatorFactory implements DavLocatorFactory {
   ...
   /**
    ...
    private class DavResourceLocatorImpl implements DavResourceLocator {
         ...
         * @see DavResourceLocator#getResourcePath()
         */
         ...
         * @see DavResourceLocator#getWorkspacePath()
         */
         ...
         * @see DavResourceLocator#getWorkspaceName()
         */
         ...
         * @see DavResourceLocator#isSameWorkspace(DavResourceLocator)
         */
         ...
         * {@link EncodeUtil#escapePath(String) escaped}.
         *
         * @param isCollection
         ...
         * @see DavResourceLocator#isRootLocation()
         */
         ...
         *
         * @return factory
         * @see DavResourceLocator#getFactory()
         */
