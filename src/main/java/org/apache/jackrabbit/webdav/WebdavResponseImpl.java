...
public class WebdavResponseImpl implements WebdavResponse {
     ...
     * @param exception
     * @throws IOException
     * @see DavServletResponse#sendError(DavException)
     ...
     * @param locks
     * @throws IOException
     * @see DavServletResponse#sendRefreshLockResponse(ActiveLock[])
     */
     ...
     * @param subscription
     * @throws IOException
     * @see org.apache.jackrabbit.webdav.observation.ObservationDavServletResponse#sendSubscriptionResponse(Subscription)
     */
     ...
     * @throws IOException
     * @see org.apache.jackrabbit.webdav.observation.ObservationDavServletResponse#sendPollResponse(EventDiscovery)
     */
